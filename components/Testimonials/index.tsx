...
const reviews = [
  {
    ...
    username: "Shopify Store Owner, India",
  ...
  },
  {
    name: "Gute Reise",
    username: "Shopify Store Owner, India",
    body: "I absolutely love this app and its support team! They helped me set up everything smoothly, and their assistance has been incredible. This app is a game-changer for my store, and I highly recommend it to everyone looking to enhance their cash-on-delivery functionality. Definitely a must-have!",
    img: "https://avatar.vercel.sh/gutereise",
  },
  {
    name: "My Store",
    username: "Shopify Store Owner, India",
    body: "Excellent app, excellent customer support. Just loved everything about it.",
